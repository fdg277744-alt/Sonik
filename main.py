...
# ==================== إعدادات البوت ====================
stopuser = {}
token = "8441288840:AAFO836YXAXRczPShJXSZn7fVNnDkwYfz1k"
...
اهلا بك عزيزي {first_name}
📊 نقاطك: {get_points(user_id)}
للحصول على نقاط أو اشتراك تواصل مع المالك: @ISoonik
</b>
''', reply_markup=keyboard)
            ...
            with open("combo.txt", 'r') as file:
                ...
                for cc in lino:
                    ...
                    if any(kw in raw_response for kw in APPROVED_KEYWORDS):
                        category = 'approved'
                        live += 1
                        # تم إزالة إشعار المالك عند التفعيل
